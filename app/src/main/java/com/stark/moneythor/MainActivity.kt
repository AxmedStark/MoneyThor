...
import com.stark.moneythor.databinding.ActivityMainBinding
import java.util.*
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    fun nightMode(){
        ...
        val actionLayout:View = binding.navigationView.getMenu().findItem(R.id.dark_mode).getActionView() as View
    ...
    private fun fingerPrintSensor() {
        ...
        val biometricPrompt = BiometricPrompt.Builder(this)
            ...
            .setDescription("Please enter your PIN to continue")
            .build()
