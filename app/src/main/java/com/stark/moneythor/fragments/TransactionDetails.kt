...
import com.stark.moneythor.databinding.FragmentTransactionDetailsBinding
...
class TransactionDetails : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.type.text = transaction.data.type
        ...
        binding.repeatTransaction.setOnClickListener { repeatTransaction() }

        return binding.root
    }

    private fun repeatTransaction() {
        val repeatedTransaction = transaction.data.copy(id = null) // Set id to null to create a new transaction
        val action = TransactionDetailsDirections.actionTransactionDetailsToAddTransaction(repeatedTransaction, false)
